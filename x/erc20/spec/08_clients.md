...
Find below a list of  `keytomd` commands added with the  `x/erc20` module. You can obtain the full list by using the `keytomd -h` command. A CLI command can look like this:
